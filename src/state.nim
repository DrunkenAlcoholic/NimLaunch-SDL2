...
# ── Defaults as TOML text (same as NimLaunch) ───────────────────────────
const defaultToml* = """
# ==========================
...
#   highlightBgColorHex = Background of selected/highlighted item
#   highlightFgColorHex = Text color of selected/highlighted item
